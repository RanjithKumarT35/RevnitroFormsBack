...
router.post("/", async (req, res) => {
  try {
    ...
    const Subject = "Car Service Request From RevNitro";
    const content = `
    <!DOCTYPE html>
    <html lang="en">
      <head>
      ...
      <body>
        ...
        <div class="notification-container">
          ...
          <p>Car Name: <strong>${details.carname}</strong></p>
          <p>Car Model: <strong>${details.carmodel}</strong></p>
          <p>My Issues: <strong>${details.issues}</strong></p>
          <p>Service Loction: <strong>${details.serviceloction}</strong></p>
          <br/>
          <br/>
