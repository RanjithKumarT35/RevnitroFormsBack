...
router.post("/", async (req, res) => {
  try {
    ...
    const Subject = "Bike Consultation Request From RevNitro";
    const content = `
    <!DOCTYPE html>
    <html lang="en">
      <head>
      ...
      <body>
        ...
        <div class="notification-container">
          <p>Looking For: <strong>${details.bikeType}</strong></p>
          <p>Company Name: <strong>${details.bikename}</strong></p>
          ...
          <p>My Question: <strong>${details.question}</strong></p>
